...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/Users/minje/.rubies/ruby-3.2.0")
  ...
  CONFIG["configure_args"] = " '--prefix=/Users/minje/.rubies/ruby-3.2.0' '--with-opt-dir=/opt/homebrew/opt/readline:/opt/homebrew/opt/libyaml:/opt/homebrew/opt/gdbm' '--with-openssl-dir=/opt/homebrew/opt/openssl@3'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/Users/minje/.rubies/ruby-3.2.0"
  ...
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/opt/homebrew/opt/readline/include -I/opt/homebrew/opt/libyaml/include -I/opt/homebrew/opt/gdbm/include -D_XOPEN_SOURCE -D_DARWIN_C_SOURCE -D_DARWIN_UNLIMITED_SELECT -D_REENTRANT $(DEFS) $(cppflags)"
  ...
  CONFIG["host"] = "$(target)"
  CONFIG["build_os"] = "darwin23.6.0"
  CONFIG["build_vendor"] = "apple"
  CONFIG["build_cpu"] = "aarch64"
  CONFIG["build"] = "aarch64-apple-darwin23.6.0"
