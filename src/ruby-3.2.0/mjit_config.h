...
#ifdef LOAD_RELATIVE
#define MJIT_HEADER_INSTALL_DIR "/include/ruby-3.2.0/arm64-darwin23"
#else
#define MJIT_HEADER_INSTALL_DIR "/Users/minje/.rubies/ruby-3.2.0/include/ruby-3.2.0/arm64-darwin23"
#endif
